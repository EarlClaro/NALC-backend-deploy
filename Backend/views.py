...
class MessageCreateView(generics.CreateAPIView):
    ...
    def clean_sql_query(self, sql_query):
        """
        Cleans up the SQL query generated by LangChain to ensure it is valid.
        Removes Markdown-like SQL code formatting and leading/trailing whitespace.
        """
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Execute the cleaned SQL query and fetch the results
            with connections['default'].cursor() as cursor:
        ...
        # Increment message count for STANDARD users atomically
