"""
Django settings for NALCBackend project.
...
ALLOWED_HOSTS = ['*', 'ipamsdjango.mysql.database.azure.com']
...
WSGI_APPLICATION = 'NALCBackend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PORT': '3306',
        'OPTIONS': {
            # Include SSL options if needed for Azure
        },
    }
}
